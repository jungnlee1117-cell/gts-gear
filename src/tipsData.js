...
const VETERAN = [
  act("veteran", "energy-read", "아이 에너지 읽기",
    "수업 시작 전 아이들 컨디션을 10초 안에 파악하는 법", ["관찰", "핵심"], "eye",
    ["아이들 입장할 때 걸음·표정·소리를 관찰한다.", "에너지 높음/보통/낮음 중 하나로 판단한다.", "그에 맞춰 첫 5분 활동 강도를 정한다."],
    ["불필요한 진정·흥분 유발을 줄인다.", "수업 흐름이 자연스러워진다.", "현장 대응 속도가 빨라진다."],
    ["에너지 높으면 활동형 인사", "낮으면 리듬·음악 활용", "매 수업 전 10초 습관화"],
    { duration: "수업 전 10초", age: "전연령", type: "노하우", materials: "없음" },
  ),
  act("veteran", "plan-b", "플랜 B 항상 준비",
    "활동이 일찍 끝나거나 안 될 때 바로 쓰는 예비 활동", ["준비", "핵심"], "lightbulb",
    ["인기 게임 2~3개를 머릿속에 저장한다.", "교구 없이 할 수 있는 활동 1개 준비.", "시간이 남으면 난이도 올리기, 안 되면 플랜 B."],
    ["당황하지 않고 수업을 이어간다.", "아이들이 선생님을 신뢰한다.", "시간 관리가 쉬워진다."],
    ["Simon Says, Red Light는 만능", "교구 정리 전 2분 게임도 OK", "같은 게임 반복해도 아이들은 좋아함"],
    { duration: "상시", age: "전연령", type: "노하우", materials: "없음" },
  ),
  quick("veteran", "voice-control", "목소리 톤 조절", "크기·속도·톤으로 집중을 끄는 기술", ["소통", "핵심"], "mic", { info: { duration: "상시", type: "노하우" } }),
  quick("veteran", "transition-smooth", "전환 30초", "활동 사이 전환을 매끄럽게 하는 법", ["흐름", "핵심"], "arrow", { info: { duration: "전환 시", type: "노하우" } }),
  quick("veteran", "praise-specific", "구체적 칭찬", "잘했어요 대신 구체적으로 칭찬하기", ["칭찬", "동기"], "heart", { info: { duration: "상시", type: "노하우" } }),
  quick("veteran", "rule-simple", "규칙 3개 원칙", "규칙은 최대 3개, 짧고 명확하게", ["규칙", "질서"], "book", { info: { duration: "수업 시작", type: "노하우" } }),
  quick("veteran", "attention-reset", "집중 리셋", "집중이 흐트러졌을 때 30초 리셋", ["집중", "현장"], "target", { info: { duration: "30초", type: "노하우" } }),
  quick("veteran", "pair-strategy", "짝 정하기", "매번 새 짝 vs 고정 짝 활용법", ["협동", "관계"], "users", { info: { duration: "상시", type: "노하우" } }),
  quick("veteran", "time-buffer", "시간 버퍼", "항상 3~5분 여유 두기", ["시간", "계획"], "timer", { info: { duration: "계획 시", type: "노하우" } }),
  quick("veteran", "end-strong", "마무리가 기억에 남는다", "마지막 3분이 수업 인상을 결정", ["마무리", "핵심"], "flag", { info: { duration: "마지막 3분", type: "노하우" } }),
];
