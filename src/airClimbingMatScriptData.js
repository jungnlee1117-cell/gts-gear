...
export const AIR_CLIMBING_MAT_ACTIVITIES = [
    ...
    // ─────────────────────────────────
    {
      ...
      script: [
        {
          ...
          lines: {
            ...
            inquiry: "Take a look at this. What possibilities do you see here?",
          },
        },
        {
          who: "kids",
          action: "추측하며 대답",
          lines: { foundation: "올라갈 수 있어요!! 산 같아요!!", interactive: "We can climb it! It looks like a mountain!", inquiry: "It looks climbable — maybe a hill?" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Right, you can climb it. But we need to be careful of falling, so we'll crawl up using hands and knees.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "When descending, always lead with your feet, not your head.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Who's ready first? I'm looking for someone with good posture and focus... Jin, you're up.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Jin, are you ready? Can you do it? (Yes I'm ready / I can do it) Alright, go ahead.",
          },
        },
        {
          who: "kids",
          action: "기어 올라가는 시도",
          lines: { foundation: "(기어 올라가며) 으아 힘들어요!", interactive: "This is hard!", inquiry: "I need to grip carefully!" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Excellent work, Jin! Let's all clap. Who's next? Let's line up and take turns.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Once you're down, rejoin the back of the line for another turn.",
          },
        },
      ],
      ...
      cardLines: {
        ...
        inquiry: ["Crawl up, hands and knees", "Feet first descending", "Ready? Can you do it?", "Nice climb — who's next?"],
      },
    ...
    // ─────────────────────────────────
    {
      ...
      script: [
        {
          ...
          lines: {
            ...
            inquiry: "Alright, take a seat. What's the next possibility here?",
          },
        },
        {
          who: "kids",
          action: "매트 아래 공간 보며 추측",
          lines: { foundation: "(생각하며) 음... 모르겠어요!", interactive: "Hmm... I'm not sure!", inquiry: "There's a space underneath..." },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "This becomes a tunnel. Legend says treasures were once hidden in caves like this. Let's go explore.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Are you ready? (Yes I'm ready) Can you do it? (I can do it) Let's go!",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Let's see... I'm choosing based on focus this time — Woo-young, you're up.",
          },
        },
        {
          who: "kids",
          action: "터널 안으로 기어 들어가기",
          lines: { foundation: "(기어가며) 어두워요~! 보물 찾으러 간다!!", interactive: "It's dark! Going to find treasure!", inquiry: "I have to crouch low to fit through!" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Any treasure spotted? You're almost through.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Great exploration, Woo-young! Let's clap. Who's our next adventurer?",
          },
        },
      ],
      ...
      cardLines: {
        ...
        inquiry: ["Tunnel — legend of hidden treasure", "Ready? Can you do it?", "Almost through!", "Next adventurer?"],
      },
    ...
    // ─────────────────────────────────
    {
      ...
      script: [
        {
          ...
          lines: {
            ...
            inquiry: "Now that we're at the summit, what's a fun way down?",
          },
        },
        {
          who: "kids",
          action: "추측",
          lines: { foundation: "미끄러져요!! 미끄럼틀처럼!!", interactive: "We can slide! Like a slide!", inquiry: "Maybe slide down like a slope?" },
        },
        {
          who: "teacher",
          action: "동의하며 자세 설명",
          lines: {
            ...
            inquiry: "Exactly. Sit down with your hands beside you for control as you slide.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "One person at a time — wait for the previous person to clear the area.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Let's pick based on enthusiasm — Seo-yoon, you're up first.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Ready? (Yes I'm ready) Go ahead.",
          },
        },
        {
          who: "kids",
          action: "신나게 미끄러져 내려가기",
          lines: { foundation: "(미끄러지며) 와아아아!!", interactive: "Wheee!!", inquiry: "That was fast!" },
        },
        {
          who: "teacher",
          action: "환호하며 다음 사람",
          lines: {
            ...
            inquiry: "Great descent! Let's clap. Who wants to go next?",
          },
        },
      ],
      ...
      cardLines: {
        ...
        inquiry: ["One at a time, sit, hands beside", "Ready?", "Great descent!", "Next?"],
      },
    ...
    // ─────────────────────────────────
    {
      ...
      script: [
        {
          ...
          lines: {
            ...
            inquiry: "We crawled up before. Is there another way to reach the top?",
          },
        },
        {
          who: "kids",
          action: "추측",
          lines: { foundation: "걸어서요!! 서서 올라가요!!", interactive: "Walking! Standing up!", inquiry: "Maybe walking, standing the whole time?" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Correct. This requires more balance — slow, deliberate steps, one at a time.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Spread your arms like wings for better balance and stability.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Let's pick the calmest, most patient one — Min-jun, your turn.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Can you do it? (I can do it) Alright, go.",
          },
        },
        {
          who: "kids",
          action: "휘청거리며 걸어 올라가기",
          lines: { foundation: "(휘청거리며) 흔들려요!!", interactive: "I'm wobbling!", inquiry: "This needs so much balance!" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Outstanding climb! Let's clap. Who's ready to try next?",
          },
        },
      ],
      ...
      cardLines: {
        ...
        inquiry: ["Slow, deliberate steps", "Can you do it?", "Outstanding climb!", "Who's trying next?"],
      },
    ...
    // ─────────────────────────────────
    {
      ...
      script: [
        {
          ...
          lines: {
            ...
            inquiry: "Looking at this curved shape, what comes to mind?",
          },
        },
        {
          who: "kids",
          action: "추측",
          lines: { foundation: "배요!! 보트 같아요!!", interactive: "A boat! It looks like a boat!", inquiry: "It looks like a boat hull." },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Correct. The boat will wobble, so balance is key. Move slowly to maintain control.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Let's choose based on readiness — Ha-eun, your turn.",
          },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Ready? (Yes I'm ready) Can you do it? (I can do it) Go ahead.",
          },
        },
        {
          who: "kids",
          action: "균형 잡으며 걷기",
          lines: { foundation: "(휘청거리며) 흔들려요!! 배다!!", interactive: "It's wobbly! Like a real boat!", inquiry: "I keep adjusting my weight!" },
        },
        {
          who: "teacher",
          ...
          lines: {
            ...
            inquiry: "Excellent balance! Let's clap. Who's our next sailor?",
          },
        },
      ],
      ...
      cardLines: {
        ...
        inquiry: ["Boat hull — balance is key", "Ready? Can you do it?", "Excellent balance!", "Next sailor?"],
      },
